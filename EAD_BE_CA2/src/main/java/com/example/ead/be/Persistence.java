...
public class Persistence {
  ...
  public Persistence() {
    String connString = System.getenv("databaseUrl");
    String dbName = System.getenv("databaseName");
    String colName = System.getenv("databaseCollection");
  ...
  // The aim of this method is to mimic main to check if my refactoring (in prep
  // for the webservices) is OK.
  public void main2() {
    addRecipes(recipes);
    ...
    // Purposely skipping to replicate the find and update, as they are not needed
  ...
  public static void main(String[] args) {
    ...
    String connString = System.getenv("databaseUrl");
    String dbName = System.getenv("databaseName");
    String collectionName = System.getenv("databaseCollection");
    if (connString == null || connString.isBlank()) {
      connString = "mongodb://localhost:27017";
      dbName = "ead_ca2";
      collectionName = "ead_2024";
    }
    ConnectionString mongoUri = new ConnectionString(connString);
    ...
    // the *updated* document to us. By default, we get the document as it was
    // *before*
    // the update.
